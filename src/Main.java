...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Você avança pela Floresta Sombria, quando de repente se depara com um Caveleiro do Rei Demônio!");
        ...
        Aldric aldric;
        System.out.println("\nBatalha começando! " + aldrich.getNome() + " contra " + caveleiroSombrio.getNome());
